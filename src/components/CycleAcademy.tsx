...
const ARTICLES: Article[] = [
  ...
  },
  {
    id: 'art-medical-6',
    category: 'medical',
    title: 'When Menstrual Symptoms Warrant Clinical Care',
    readTime: '4 min read',
    summary:
      'Clear, empowering guidelines on what is typical versus red-flag symptoms that should be discussed with a doctor.',
    content: [
      'Menstruation is a vital sign, and your symptoms provide meaningful clues about your endocrine and pelvic health.',
      'When to Schedule a Clinical Appointment:',
      '• Heavy Menstrual Bleeding (Menorrhagia): Soaking through one or more sanitary pads or tampons every hour for two or more consecutive hours, or passing blood clots larger than a quarter.',
      '• Debilitating Pain: Pelvic or lower back pain that does not respond to standard pain relievers and causes you to miss work, school, or bed rest.',
      '• Irregular or Absent Cycles: Cycles consistently shorter than 21 days, longer than 35 days, or no period for 90+ consecutive days (when not pregnant).',
      '• Intermenstrual Bleeding: Unexplained spotting or bleeding between periods or after sexual intercourse.',
      'Remember: NIVA is an empowering wellness companion, but your gynecologist or primary care physician is your partner in diagnostic medicine.',
    ],
    keyTakeaways: [
      'Bleeding through a pad every hour for 2+ hours is a medical red flag.',
      'Severe pain is common, but it is NOT physiologically normal.',
      'Track your symptoms in NIVA to share clear historical data with your doctor.',
    ],
  },
];
